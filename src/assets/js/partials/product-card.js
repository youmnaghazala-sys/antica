...
class ProductCard extends HTMLElement {
  ...
  async render() {
    ...
    this.innerHTML = `
      ...
      this.product.quantity === 0 ? "filter: grayscale(1);" : ""
    }">
          ...
          ${
            !this.horizontal && !this.fullImage
              ...
              class="s-product-card-wishlist-btn animated ${
                this.isInWishlist
                  ? "s-product-card-wishlist-added pulse-anime"
                  : "not-added un-favorited"
              }"
        ...
        <div class="s-product-card-content" style="${
          this.product.quantity === 0 ? "filter: grayscale(1);" : ""
        }">
          ${
          ...
          <div class="s-product-card-content-sub ${
            ...
            ${
              this.product?.is_out_of_stock
                ? `<p class="s-product-card-out-of-stock">${this.outOfStock}</p>`
                : ""
            }
          </div>
          ...
          !this.hideAddBtn && this.horizontal
            ...
            ${
              this.hasProductOptions
                ? `<a href="${
                    this.product?.url
                  }" class="border !bg-primary w-full flex items-center justify-center h-[40px] border-primary text-white">
